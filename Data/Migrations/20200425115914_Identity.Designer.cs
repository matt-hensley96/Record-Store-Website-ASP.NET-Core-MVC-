...
namespace Goldies.Migrations
{
    ...
    [Migration("20200425115914_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Goldies.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2020, 4, 25, 11, 59, 13, 533, DateTimeKind.Utc).AddTicks(511),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("Goldies.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("Goldies.Data.Entities.Order", b =>
                {
                    b.HasOne("Goldies.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Goldies.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
